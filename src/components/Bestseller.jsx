...
export default function Bestseller() {
  ...
  return (
    <>
    <div className='w-full py-24 flex justify-center' data-aos="zoom-in">
        <div className='w-[80%] lg:w-[30%] text-center md:w-[50%]'>
            <h1 className='text-5xl font-bold p-3'>Bestseller</h1>
            <p className='text-center'>Lorem ipskk adipisicing elit. Reiciendis eos officia expedita obcaecati nobis similique.</p>
        </div>
